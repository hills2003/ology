...
function CalendarDayButton({
  ...
  const specialDays: { date: Date; color: string }[] = [
    { date: new Date(2026, 1, 1), color: "bg-[rgba(127,168,212,0.3)]" }, // Feb 1
    { date: new Date(2026, 1, 4), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 4
    { date: new Date(2026, 1, 8), color: "bg-[rgba(212,165,116,0.3)]" }, // Feb 8
    { date: new Date(2026, 1, 14), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 14
    { date: new Date(2026, 1, 17), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 17
    { date: new Date(2026, 1, 20), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 20
    { date: new Date(2026, 1, 22), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 22
    { date: new Date(2026, 1, 26), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 26
    { date: new Date(2026, 1, 27), color: "bg-[rgba(155,143,212,0.3)]" }, // Feb 27
  ];
  const dayColor = specialDays.find((d) => isSameDay(d.date, day))?.color;
  ...
  return (
    <Button
      ...
      className={cn(
        "flex h-[35.982px] flex-col justify-center items-center justify-self-stretch",
        ...
        specialDays.find((d) => isSameDay(d.date, day.date))?.color, // <-- add this
        defaultClassNames.day,
        className,
      )}
      {...props}
